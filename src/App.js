      ...
      <div className="d-flex align-items-center justify-content-between">
        ...
        <div className="d-flex align-items-center justify-content-end">
          ...
          <div>
            ...
            <img id="menu-icon" src="images/menu icon.svg" onClick={() => mobileMenuOpen()}></img>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="container">
        <div id="mobile-menu" className="container">
          <div className="d-flex justify-content-between">
            <img src="images/white logo.svg"></img>
            <img src="images/close.svg" onClick={() => mobileMenuClose()}></img>
          </div>
          <div>
...
function MobileSubMenu() {
  return (
    <li className="nav-item mobile-menu-item">
      <a className="mobile-menu-link" href="#" onClick={() => mobileSubMenu()}>
        <img id="mobile-submenu-icon" src="/images/white arrow down.svg"></img>
        خدمات
      </a>
    ...
    <div id="hero-section" className="container">
      <div className="row d-flex align-items-center">
        <div className="col-md-7 col-lg">
          <img id="heroimg" src="https://new.alopeyk.com/_nuxt/image/9575c5.webp" />
        </div>
    ...
    <div id="slider-section" className="container d-flex flex-column align-items-center">
      <div id="pointerdiv-container">
        <div id="pointerdiv" className="d-flex flex-row-reverse justify-content-around">
          <img id="pointer1" src="images/pointer.svg"></img>
          <img id="pointer2" src="images/pointer.svg"></img>
          <img id="pointer3" src="images/pointer.svg"></img>
          <img id="pointer4" src="images/pointer.svg"></img>
          <img id="pointer5" src="images/pointer.svg"></img>
          <img id="pointer6" src="images/pointer.svg"></img>
        </div>
      </div>
...
function SliderItem(props) {
  return (
    <div id={props.id} className="slideritem" onClick={() => { sliderSelect(parseInt(props.id.charAt(10))); timer(); }}>
      <img id={"img" + props.id} src={props.img}></img>
      <p>{props.text}</p>
    </div>
  );
}
  ...
  return (
    <li id={props.id} className="nav-item submenuitem">
      <a className="nav-link d-flex justify-content-between" href={props.href}>
        <img className="submenuitemimg" src={props.img}></img>
